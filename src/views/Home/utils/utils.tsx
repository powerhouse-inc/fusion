...
export const createTooltipFormatter =
  ...
  <div style="background-color:${
    ...
    }";line-height:24px;>${noZeroValues?.[0]?.name}</div>
      ...
      <div style="display:flex;flex-direction:column;gap:8px;min-width:194px;max-width:450px;">
        ...
        <div style="display: flex;justify-content: space-between;align-items: center;border:2px solid blue">  
          <div style="display:flex;align-items:center">
            <span style="font-size:14px;font-weight:600;line-height:22px;color:${
              theme.palette.isLight ? theme.palette.colors.charcoal[300] : '#B6BCC2'
            };max-width:350px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">Total:</span>
          </div>
          <div style="font-size:14px;font-weight:600;line-height:22px;color:${
            theme.palette.isLight ? theme.palette.colors.charcoal[900] : '#EDEFFF'
