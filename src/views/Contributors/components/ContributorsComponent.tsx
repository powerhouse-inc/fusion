...
import GroupScopesContributors from '@/views/Home/components/Contributors/GroupScopesContributors';
import Profile from '@/views/Home/components/Contributors/Profile';
import ProfileUpdated from '@/views/Home/components/Contributors/ProfileUpdated';
import { getProfileUpdate } from '@/views/Home/utils/utils';
...
const ContributorsComponent: FC<Props> = ({ contributor, className, hasDefaultColors = true, textDefault }) => {
